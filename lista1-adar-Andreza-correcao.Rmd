...
> o Software não multiplica nada. O logaritmo natural é o default. Logo log(x) é ln(x), ou seja o logaritmo natural de x. 
...
knitr::include_graphics("https://github.com/andreza-santos/resolucao-lista1-adar/blob/master/conj-eqs-tomasella2003.png")
```

> Ao invés do nome do arquivo, para fins de reprodutibilidade poderia ter colocado o link para a imagem no seu github. Isso fez com que ao clicar em knitr seu html não fosse gerado.
...
>JDT: Faltou imprimir o valor de tw.

```{r}
source("https://raw.githubusercontent.com/andreza-santos/resolucao-lista1-adar/master/solucao-q10-Andreza.R", echo = TRUE)
```
