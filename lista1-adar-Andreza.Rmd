...
mult_result1 <- result1 * 2
mult_result1

sub_result_mult <- mult_result1 - 10
sub_result_mult

result_final <- sub_result_mult / 4
result_final
```
...
```{r}
  ...
  tw <- tar * atan(0.151977 * (ur_ar + (8.313659)^(1/2))) + atan(tar + ur_ar) - atan(ur_ar - 1.676331) + 0.00391838 * (ur_ar)^(3/2) * atan(0.023101 * ur_ar) - 4.686035
  tw
```
